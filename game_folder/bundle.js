...
var BusinessDay = function () {
  function BusinessDay(resources) {
    _classCallCheck(this, BusinessDay);
...
var View = function () {
  ...
  _createClass(View, [{
    ...
    value: function setupProgressBar() {
      var gameObject = { myCups: this.game.cups, myLemons: this.game.lemons,
      ...
      var $section = new _progress_bar2.default(gameObject);
    ...
    value: function setupForm() {
      ...
      var price = '<span class="form-line">Price per Cup</span>';
    ...
    value: function showInventory() {
      var $div = (0, _jquery2.default)('<div class="my-inventory" id="my-inventory">');
      var $span = (0, _jquery2.default)('<span class="my-inventory-header">My Inventory</span>');
      $div.append($span);

      var cupsInventory = this.game.cups;
      $span = (0, _jquery2.default)('<span class="inventory-line">' + cupsInventory + ' cups</span>');
      $div.append($span);

      var lemonsInventory = this.game.lemons;
      $span = (0, _jquery2.default)('<span class="inventory-line">' + lemonsInventory + ' lemons</span>');
      $div.append($span);

      var sugarInventory = this.game.sugar;
      $span = (0, _jquery2.default)('<span class="inventory-line">' + sugarInventory + ' cups of sugar</span>');
      $div.append($span);

      var iceInventory = this.game.iceCubes;
      $span = (0, _jquery2.default)('<span class="inventory-line">' + iceInventory + ' ice cubes</span>');
      $div.append($span);

      var $button = (0, _jquery2.default)('<button id="go-shopping-button" type="submit" class="go-shopping-button">Go Shopping</button>');
      $div.append($button);
...
var ProgressBar = function () {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function setupProgressBar(gameObject) {
      ...
      var $div = '<div class="inventory-figure-cups">' + gameObject.myCups + ' cups</div>';
      $section += $div;
      $section += '<div></div>';
      ...
      var hours = ("0" + gameObject.hour).slice(1, 3);
      var minutes = ("0" + gameObject.minutes.toFixed(0)).slice(-2);
      var ampm = null;
      if (hours < 12 && hours > 8) {
        ampm = "am";
      } else {
